...
<x-guest-layout>
    <main class="relative flex flex-1 flex-col overflow-hidden px-4 py-8 sm:px-6 lg:px-8 ">
        <img src="{{ asset('img/bg-3.jpg') }}" class="absolute inset-0 object-cover w-full h-full" />
        <div class="absolute inset-0 text-slate-900/[0.10] [mask-image:linear-gradient(to_bottom_right,white,transparent,transparent)]">
            ...
            <svg id="a" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390.4 390.4" class="w-24 h-24 text-sky-400">
              ...
              <form class="w-full max-w-xl" method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" id="email" name="email" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required value="" />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="name" name="name" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required value="" />
                </div>
            
                <div class="grid grid-cols-3 gap-3 mb-6">
                    <div>
                        <label for="fecha_nacimiento" class="block text-sm font-semibold leading-6 text-gray-900">
                            Fecha de nacimiento
                        </label>
                        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required value="" />
                    </div>
                    <div>
                        <label for="telefono" class="block text-sm font-semibold leading-6 text-gray-900">
                            Teléfono
                        </label>
                        <input type="text" id="telefono" name="telefono" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required value="" />
                    </div>
                    <div>
                        <label for="curp" class="block text-sm font-semibold leading-6 text-gray-900">
                            CURP
                        </label>
                        <input type="text" id="curp" name="curp" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required value="" />
                    </div>

                    <div>
                        <label for="sexo" class="block text-sm font-semibold leading-6 text-gray-900">
                            Sexo
                        </label>
                        <select id="sexo" name="sexo" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required>
                    ...
                    <div>
                        <label for="tipo_sangre" class="block text-sm font-semibold leading-6 text-gray-900">
                            Tipo de sangre
                        </label>
                        <select id="tipo_sangre" name="tipo_sangre" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required>
                            <option value="">Selecciona una opción</option>
                    ...
                    <div>
                        <label for="alergias" class="block text-sm font-semibold leading-6 text-gray-900">
                            Alergias
                        </label>
                        <input type="text" id="alergias" name="alergias" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required value="" />
                    </div>
                    <div>
                        <label for="enfermedades_cronicas" class="block text-sm font-semibold leading-6 text-gray-900">
                            Enfermedades crónicas
                        </label>
                        <input type="text" id="enfermedades_cronicas" name="enfermedades_cronicas" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required value="" />
                    </div>
                    <div>
                        <label for="password" class="block text-sm font-semibold leading-6 text-gray-900">
                            Contraseña
                        </label>
                        <input type="password" id="password" name="password" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required value="" />
                    </div>
                    <div>
                        <label for="password_confirmation" class="block text-sm font-semibold leading-6 text-gray-900">
                            Verificar contraseña
                        </label>
                        <input type="password" id="password_confirmation" name="password_confirmation" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" required value="" />
                    </div>
                </div>
...
{{-- campos para registro de usuario
$table->string('name');
...
$table->string('sexo'); masculino, femenino, no_binario
$table->string('tipo_sangre'); a+, a-, b+, b-, ab+, ab-, o+, o-
