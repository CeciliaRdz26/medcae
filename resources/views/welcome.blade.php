            ...
            <section class="bg-opacity-30 py-10 sm:py-16 lg:py-24">
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="grid items-center grid-cols-1 gap-4 lg:grid-cols-2">
                        <div>
                            <p class="text-base font-semibold tracking-wider text-blue-600 uppercase">Salud y Bienestar</p>
                            <h1 class="mt-4 text-4xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-8xl">Tu Salud en un Solo Lugar</h1>
                            <p class="mt-4 text-base text-black lg:mt-8 sm:text-xl">Compra medicamentos y agenda tus citas médicas con facilidad. Solo necesitas una cuenta para empezar.</p>
                            ...
                            <p class="mt-5 text-gray-600">¿Ya eres usuario? <a href="#" title="" class="text-black transition-all duration-200 hover:underline">Inicia sesión</a></p>
                        </div>
            
                        <div>
                            <img class="w-full" src="{{ asset('img/doctores.png') }}" alt="" />
                        </div>
                    </div>
                </div>
            </section>
        ...
        <section class="pt-10 sm:pt-16 lg:pt-24">
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="max-w-2xl mx-auto text-center">
                    <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight">Estamos aquí para ayudarte a cuidar de tu salud</h2>
                    <p class="mt-6 text-lg text-gray-900">Nuestro equipo está listo para asistirte en la compra de medicamentos y en la gestión de tus citas médicas.</p>
            ...
            <div class="container mx-auto 2xl:px-12">
                <img class="w-full mt-6" src="https://cdn.rareblocks.xyz/collection/celebration/images/team/4/group-of-people.png" alt="Equipo de soporte de salud" />
            </div>
        </section>
